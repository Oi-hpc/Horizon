...
CATEGORY_LABELS = {
    ...
    "policy": {"en": "China Policy / Interpretation", "zh": "中国政策 / 解读"},
    "shenzhen": {"en": "Shenzhen", "zh": "深圳新闻"},
    "livelihood": {"en": "Livelihood", "zh": "民生"},
    "real_estate": {"en": "Housing / Real Estate", "zh": "楼市 / 房地产"},
...
class DailySummarizer:
    ...
    def _category_key(self, item: ContentItem) -> str:
        ...
        keyword_categories = [
            ...
            ("shenzhen", ("shenzhen", "深圳", "南山", "福田", "罗湖", "宝安", "龙岗", "龙华", "坪山", "光明", "前海", "大鹏", "深汕")),
            ("real_estate", ("real estate", "property", "housing", "mortgage", "home sales", "developer", "land auction", "rent", "房地产", "楼市", "住房", "房贷", "按揭", "土地出让", "土拍", "租金", "新房", "二手房", "保障房", "安居房", "城中村", "城市更新")),
            ("livelihood", ("livelihood", "employment", "jobs", "income", "wage", "education", "school", "healthcare", "medical", "pension", "social security", "consumption", "consumer", "transport", "utility", "cost of living", "民生", "就业", "收入", "工资", "教育", "学校", "医疗", "医保", "养老", "社保", "消费", "交通", "通勤", "物价")),
            ("policy", ("policy interpretation", "policy document", "regulation", "ministry", "official interpretation", "statistics bureau", "政府政策", "政策解读", "政策文件", "国务院", "部委", "国家统计局", "发改委", "财政部", "教育部", "央行", "人民银行")),
